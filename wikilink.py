...
class WikiLinkCommand(sublime_plugin.TextCommand):
    ...
    def run(self, edit):
        ...
        scope = (self.view.substr(self.view.extract_scope(location.a))
                     .replace("*", ""))
        ...
        if "link.external.Wiki" in self.view.scope_name(location.a):
            ...
            # print("Selected word scope is '%s'" %
            #        self.view.scope_name(location.a))
            ...
            sublime.status_message("Can only open WikiWords, email addresses"
                                   " or web addresses.")
